...
namespace P1_DaytonSchuh.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public const string SessionKeyLocation = "_DefaultLocation";
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //HttpContext.Session.SetInt32(SessionKeyLocation, user.DefaultLocation);
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //user.CartId = 1;
                    user.ShoppingCart = _businessLogicClass.GetCart(user.Id);
                    // Set the session ids
                    HttpContext.Session.SetString(SessionKeyId, user.Id);
                    HttpContext.Session.SetInt32(SessionKeyLocation, user.DefaultLocation);
                    HttpContext.Session.SetInt32(SessionKeyCart, user.ShoppingCart.ShoppingCartId);
